...
//		ch = str.toCharArray();
		...
		String s1 = new String("abhiyank"); //one object in heap and one object in scp(String Constant Pool) and s1 will point to heap object
		String s2 = new String("abhiyank"); // one new object in heap & no new object in scp and will point to the object created in heap
		...
		String s3 = "abhiyank"; // creates s3 object in scp and will point to scp object(also it checks whether there is object in scp with same value or not). if there is, then no new object is created rather it points to older object only.
